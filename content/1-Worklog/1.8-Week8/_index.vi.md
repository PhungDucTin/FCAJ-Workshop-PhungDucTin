...
| **3** | **Thực hiện đồ án nhóm:** <br> - Kiểm thử Lỗ hổng Vượt quyền (BAC & IDOR): <br>&emsp; + Sử dụng tính năng Manual Request Editor của ZAP. <br>&emsp; + Đóng vai người dùng hợp lệ, cố tình phát lệnh `DELETE` nhắm vào các ID bài viết thuộc về tài khoản của người dùng khác để kiểm tra logic phân quyền tài nguyên. | 09/06/2026 | 09/06/2026 | **- Tài liệu OWASP (BAC):** <br> https://owasp.org/www-community/Broken_Access_Control <br> **- Tài liệu thực hiện Kiểm thử bảo mật:** <br> https://docs.google.com/document/d/1GEyjB94n11W4QRiCeyGlwQj5SbOsCIgL_go_GqllWzA/edit?usp=sharing|
