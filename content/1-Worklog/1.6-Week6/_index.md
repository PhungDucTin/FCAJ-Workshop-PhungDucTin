...
* Apply DevSecOps practices by integrating security scanning tools (SAST/SCA) into the CI/CD pipeline and setting up a centralized secrets storage solution on AWS.
...
| **Wed** | **AWS Learning:** <br> - Complete Lab: CI/CD for Application Release <br> - Complete Lab: Deployment Automation with AWS SAM <br> - Complete Lab: CI/CD for Serverless Applications <br> **Group Project Execution:** <br> - Project task (selected task): <br>&emsp; + Migrate environment variables from the `.env` file to AWS configuration management services. Write documentation to guide the backend team on how to retrieve configurations from AWS at runtime. <br>&emsp; + Use SonarCloud to scan the repository. | 27/05/2026 | 27/05/2026 | **- CI/CD for Application Release** <br> https://000051.awsstudygroup.com/ <br> **- Deployment Automation with AWS SAM** <br> https://000080.awsstudygroup.com/ <br> **- CI/CD for Serverless Applications** <br> https://000084.awsstudygroup.com/ <br> **- Variable Migration to AWS Systems Manager Document:** <br> https://docs.google.com/document/d/1-JWPB3X-2IkXRvHF5f19nVo686wB473vR3SE6oUKoi4/edit?usp=sharing <br> **- SonarCloud Vulnerability Report Document:** https://docs.google.com/document/d/1UeXtlMtoneGW1W65jewPU1Jn9RD6yXfjzYlGXwqMkqw/edit?usp=sharing |
...
| **Fri** | **AWS Learning:** <br> - Complete Lab: Serverless Storage and Auth with AWS Amplify <br> - Complete Lab: Custom Domains and SSL for Serverless Applications <br> - Complete Lab: Monitoring Serverless Applications <br> **Team Meeting:** <br> - Report on completed work <br> - Share information among team members | 29/05/2026 | 29/05/2026 | **- Serverless Storage and Auth with AWS Amplify** <br> https://000134.awsstudygroup.com/ <br> **- Custom Domains and SSL for Serverless Applications** <br> https://000082.awsstudygroup.com/ <br> **- Monitoring Serverless Applications** <br> https://000085.awsstudygroup.com/ |

### Achieved Results for Week 6:

* Successfully migrated the management of environment variables from `.env` files to AWS configuration management, ensuring that configuration data is stored and retrieved more securely in the deployment environment.

* Wrote documentation to guide the backend team on how to retrieve configuration values from AWS at runtime, reducing reliance on locally stored sensitive information.

### Evidence of Implementation for Week 6: 

#### 1. Offline team meeting to report results
