...
*  Phương hướng khắc phục sắp tới là rèn luyện khả năng xâu chuỗi dữ liệu đa chiều từ nhiều nguồn log khác nhau, từ đó chẩn đoán chính xác nguyên nhân gốc rễ (root-cause) của hệ thống một cách nhanh chóng và toàn diện hơn..
*  Việc trình bày các luồng kiến trúc mạng lưới và giải thích các báo cáo sự cố (như việc xử lý các cảnh báo giả - False Positives từ WAF) cho các thành viên trong nhóm đôi khi cần sự mạch lạc và trực quan hơn. Bản thân cần trau dồi cách thức truyền đạt thông tin, kết hợp tốt các sơ đồ luồng dữ liệu để đảm bảo sự thấu hiểu và phối hợp trơn tru nhất giữa bộ phận Bảo mật và bộ phận Phát triển phần mềm.